# This file contains code for generating images with text written.
# Here we are usually trying to calcualte the similarity between two characters in terms of shapes.
